...
const TotalBayar = (props) => {
    ...
    const submitTotalBayar = (totalBayar) => {
        ...
        // cek apakah keranjang tidak ada isinya
        if(props.keranjangs.length < 1){
            swal({
                title: "Keranjang kosong",
                text: "Anda belum belanja",
                icon: "error",
                button: false,
                timer: 1200,
            });
            return navigate('/'); // redirect halaman
        }

        // kalau keranjang ada isinya, maka...
